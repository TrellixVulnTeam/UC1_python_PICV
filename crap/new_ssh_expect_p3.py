...
def get_init_data():
  ...
  fn = input("Enter name of the destination file: ")

  my_Command = input("Which command? Type here: ")
...
#  paramiko.util.log_to_file("paramiko.log")
  ...
  for device in devices:
    with pxssh.pxssh(options={"StrictHostKeyChecking": "no"}) as client:
      try:
        #print(client.PROMPT)
        client.PROMPT = '[\\$\\#\\>\\%] '
        client.login(devices[device], uname, pword)
